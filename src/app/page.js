          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              <p className="text-base md:text-lg">
                フロントエンドエンジニアとして約5年間の経験を持ち、Web制作・開発に携わっております。クライアントの要望を的確に理解し、ユーザー視点を重視したモダンで使いやすいインターフェースの設計・実装を得意としています。<br></br>
                <br></br>
                API連携による非同期処理の実装検索・フィルター・保存・メッセージ機能などの開発UI/UXを意識した動的インターフェースの実装が可能です。
                <br></br>
                また、WordPressのカスタマイズや、簡単なバックエンド処理（フォーム実装・API連携など）にも対応し、制作から開発まで一貫した対応が可能です。<br></br>
                <br></br>
                新しい技術やトレンドにも常にアンテナを張り、プロジェクトに最適な技術選定と実装を心がけています。
              </p>
              <div className="pt-4">
